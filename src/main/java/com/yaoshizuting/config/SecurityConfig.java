    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(authorize -> authorize
                ...
                .requestMatchers("/campaign/public/**", "/api/campaign/public/**").permitAll()
                ...
                .requestMatchers("/support/admin/**", "/api/support/admin/**").hasRole("ADMIN")
                .requestMatchers("/notifications/admin/**", "/api/notifications/admin/**").hasRole("ADMIN")
