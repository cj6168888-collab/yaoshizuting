...
.data-table th, .data-table td { padding: 14px 16px; border-bottom: 1px solid #eef1e8; text-align: left; font-size: 13px; vertical-align: middle; }
...
.data-table tbody tr:hover { background: #fbfcf8; }
